    ...
    <Form {...verificationCodeForm}>
      <form
        ...
        onSubmit={verificationCodeForm.handleSubmit(async (data) => {
          return verifyMFAChallenge.mutateAsync({
            factorId,
        ...
        <div className={'flex flex-col gap-y-4'}>
            ...
            <div className={'flex flex-col gap-y-4'}>
              <If condition={verifyMFAChallenge.error}>
                <Alert variant={'destructive'}>
                  ...
                  <AlertTitle>
                    <Trans i18nKey={'auth:invalidVerificationCodeHeading'} />
                  </AlertTitle>

                  <AlertDescription>
                    <Trans
                      i18nKey={'auth:invalidVerificationCodeDescription'}
                    />
                  </AlertDescription>
                </Alert>
              </If>
                ...
                render={({ field }) => {
                  return (
                    ...
                    >
                      ...
                      <FormDescription>
                        <Trans
                          i18nKey={'auth:verifyActivationCodeDescription'}
                        />
                      </FormDescription>
          ...
          >
            {verifyMFAChallenge.isPending ? (
              ...
              <Trans i18nKey={'auth:submitVerificationCode'} />
            )}
          </Button>
        </div>
      </form>
  ...
  if (isLoading) {
    return (
      <div className={'flex flex-col items-center gap-y-4 py-8'}>
        ...
        <div>
          <Trans i18nKey={'auth:loadingFactors'} />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className={'w-full'}>
        <Alert variant={'destructive'}>
          ...
          <AlertTitle>
            <Trans i18nKey={'auth:factorsListError'} />
          </AlertTitle>

          <AlertDescription>
            <Trans i18nKey={'auth:factorsListErrorDescription'} />
          </AlertDescription>
        </Alert>
      </div>
    );
    ...
    <div className={'flex flex-col gap-y-4'}>
      <div>
        <span className={'font-medium'}>
          <Trans i18nKey={'auth:selectFactor'} />
        </span>
      </div>
