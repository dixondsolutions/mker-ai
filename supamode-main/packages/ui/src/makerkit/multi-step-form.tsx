...
interface MultiStepFormProps<Schema extends z.ZodType<FieldValues>> {
  schema: Schema;
 ...
 * @constructor
 */
export function MultiStepForm<Schema extends z.ZodType<FieldValues>>({
  schema,
  form,
  onSubmit,
  children,
  className,
}: React.PropsWithChildren<MultiStepFormProps<Schema>>) {
  const steps = useMemo(
    () =>
  ...
  return (
    <MultiStepFormContext.Provider
      value={multiStepForm as unknown as ReturnType<typeof useMultiStepForm>}
    >
      <form
