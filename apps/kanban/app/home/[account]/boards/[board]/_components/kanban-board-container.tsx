...
function useEditColumnAction() {
  const updateColumn = useKanbanStore(
    useShallow((state) => state.updateColumn),
  );
...
function useTaskMoveRequestedAction() {
  const moveTask = useKanbanStore(useShallow((state) => state.moveTask));
...
function useColumnMoveRequestedAction() {
  const moveColumn = useKanbanStore(useShallow((state) => state.moveColumn));
