...
const Title = ({ step }: { step: BlogPostCreatorStep }) => {
  switch (step) {
          ...
          <div className={'flex flex-col space-y-1.5'}>
            <div className="group relative flex justify-between space-x-2">
              ...
              <textarea
                ...
                className={
                  'hover:bg-muted focus:ring-primary min-h-9 w-full resize-none rounded-md bg-transparent px-2 py-2 text-sm outline-none invalid:ring-red-500 focus:ring-2'
                }
              />
          ...
          <div className={'flex flex-col space-y-2.5'}>
            ...
            >
              ...
              <input
                ...
                className={
                  'hover:bg-muted focus:ring-primary h-9 w-full rounded-md bg-transparent px-2 py-1 text-base outline-none invalid:ring-red-500 focus:ring-2'
                }
              />
              ...
              <div key={field.id} className={'flex flex-col space-y-1'}>
                ...
                >
                  ...
                  <input
                    ...
                    className={
                      'hover:bg-muted focus:ring-primary h-9 w-full rounded-md bg-transparent px-2 py-1 text-lg font-semibold outline-none invalid:ring-red-500 focus:ring-2'
                    }
                  />
...
function SectionPlaceholder(props: React.PropsWithChildren) {
  return (
    <div className={'bg-muted border border-dashed p-4 text-center text-sm'}>
      {props.children}
    </div>
  );
}
